...
#'  white. `shift` takes a value between 0 and 1, where 0 means the lightness
#'  stays unchanged and 1 means completely white. As an example, if the lightness
#'  of the color is 0.6 and `shift` is 0.5, the lightness will be set to the
...
#'  If `space = "combined"` then the colors are transformed into HSL and
...
#'
#' @inheritParams color
#' @param shift A number between 0 and 1. 0 will do zero lightening, and 1 will
#'  do complete lightening, turning the color to white. Defaults to 0.5.
#' @param space A character string specifying the color space in which adjustment
...
#'  lightness) where the lightness of the color will be modified. The lightness
#'  of a color takes a value between 0 and 1, with 0 being black and 1 being
#'  white. `shift` takes a value between 0 and 1, where 0 means that the
#'  lightness stays unchanged and 1 means completely black. As an example, if
#'  the lightness of the color is 0.6 and `shift` is 0.5, then the lightness
...
#' @param shift A number between 0 and 1. 0 will do zero darkening, and 1 will
#'  do complete darkening, turning the color to black. Defaults to 0.5.
#'
#' @return A `color` object of the same length as `col`.
#' @export
#'
#' @seealso [clr_lighten()]
#' @examples
