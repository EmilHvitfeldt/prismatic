test_that("extract_rgba rgba functions work", {
...
test_that("extract_rgb hsl functions work", {
...
test_that("extract_rgb hcl functions work", {
  colors <- topo.colors(10)
